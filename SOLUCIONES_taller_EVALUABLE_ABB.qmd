...
df = subset(listings_common0_select, date=="2024-09-13" & (neighbourhood_cleansed=="Palma"|neighbourhood_cleansed=="Pollença"))
precios = subset(df, price>50 & price<400)[["price"]]
hist(precios, freq=FALSE, xlab="Precio", main="Histograma de precios entre 50 y 400", breaks=20)
polygon(density(precios), col="#ff000044")
hist(df[["number_of_reviews"]], freq=FALSE, main="Histograma de numero de reviews", xlab="Numero reviews", breaks=20)
polygon(density(df[["number_of_reviews"]]), col="#ff000044")
```
Se puede comprobar que ninguna de las graficas mostradas se asemeja a una distribución normal.
